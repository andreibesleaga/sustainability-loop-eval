...
The article claims that three *compositions* (not their parts) had no located precedent. A claim of
absence is only as good as the search behind it, so the search is written down here. Sources,
phrasings and dates are those of the actual audits (2026-08-20); the full audit notes with every
near-miss are in the author's records and are summarized below.
...
Absence of evidence in these sources on that date. A reader who finds a prior composition is asked
