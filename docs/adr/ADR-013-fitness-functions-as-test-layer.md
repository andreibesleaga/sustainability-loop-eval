...
- The result is a table a reviewer can read (`results/fitness.md`). At v1.0.0 — the snapshot the article cites — that was **9 of 9 green over 10,994 cases**; at v1.1.0 it is 12 of 12 over 13,392.
- Two of the twelve, F7 and F12, are static checks rather than properties over generated cases. Their check counts are included in the total.
