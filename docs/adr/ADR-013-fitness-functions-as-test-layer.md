...
- The result is a table a reviewer can read (`results/fitness.md`). At v1.0.0 — the snapshot the article cites — that was **9 of 9 green over 10,994 cases**; at v1.1.0 it is 13 of 13 over 14,981.
