...
Session working material, kept out of the living docs on purpose: the docs layer
stays clean and current, and everything historical lands here, dated and frozen.
...
its date. The living, checked documents are [`docs/`](../docs/), the
[README](../README.md), [RESEARCH.md](../RESEARCH.md) and the
