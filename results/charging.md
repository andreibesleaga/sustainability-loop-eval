...
| ungated argmin (scheduler alone, no gate) | 2981000 ± 0 | 2208.1 ± 0 | **32.85 ± 0.12** | 1339.5 ± 3.2 | n/a | n/a | n/a | 6.29 ± 0.03 | n/a | n/a |
...
| ungated argmin (scheduler alone, no gate) | 3561400 ± 1596 | 2638.1 ± 1.2 | **16.53 ± 0.06** | 1089.7 ± 9.1 | n/a | n/a | n/a | 8.93 ± 0.03 | n/a | n/a |
...
- **What the gate contributes here (R13):** the ungated argmin arm is the same scheduler with no gate, no budget and no owner consent — 32.85% ungated vs 32.51% governed in winter, 16.53% ungated vs 16.04% governed in summer. In this scenario governance can only *subtract* carbon saving: `allow`, `degrade` and `escalate` all yield the same shift, while `block` and `terminate` fall back to naive charging. What the gate buys is authority, auditability and a bounded human cost, not additional carbon. Read the E3 headline as the price of governing a saving the scheduler already had.
